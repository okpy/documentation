...
[strunk-white]: https://en.wikipedia.org/wiki/The_Elements_of_Style
  ...
  * [The Elements of Python Style](#the-elements-of-python-style)
    * [Follow Most PEP8 Guidelines](#the-elements-of-python-style-follow-most-pep8-guidelines)
    * [Flexibility on Line Length](#the-elements-of-python-style-flexibility-on-line-length)
    * [Consistent Naming](#the-elements-of-python-style-consistent-naming)
    * [Nitpicks That Aren't Worth It](#the-elements-of-python-style-nitpicks-that-arent-worth-it)
    * [Writing Good Docstrings](#the-elements-of-python-style-writing-good-docstrings)
    * [Paradigms and Patterns](#the-elements-of-python-style-paradigms-and-patterns)
    * [A Little Zen for Your Code Style](#the-elements-of-python-style-a-little-zen-for-your-code-style)
    * [Six of One, Half a Dozen of the Other](#the-elements-of-python-style-six-of-one-half-a-dozen-of-the-other)
    * [Standard Tools and Project Structure](#the-elements-of-python-style-standard-tools-and-project-structure)
    * [Some Inspiration](#the-elements-of-python-style-some-inspiration)
    * [Contributors](#the-elements-of-python-style-contributors)
...
## Style Guide Contributors

Source: Elements of Python Style: github.com/amontalenti/elements-of-python-style
